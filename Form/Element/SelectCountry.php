 ...
 * @see        http://27.org/isocountrylist
 ...
 * @license    http://www.opensource.org/licenses/bsd-license.php New BSD License
 */
class Leek_Form_Element_SelectCountry extends Zend_Form_Element_Select
{
    /**
     * List of countries
     *
    ...
    public function init()
    {
        ...
        foreach ($this->_countries as $iso => $name) {
            $this->addMultiOption($iso, $name);
        }
